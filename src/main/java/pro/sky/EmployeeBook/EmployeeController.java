...
public class EmployeeController {
    ...
    @GetMapping(path = "/add")
    public String addEmployeee (@RequestParam ("firstName") String firstName, @RequestParam ("lastName") String lastName) {
    ...
    @GetMapping(path = "/all")
    public String allEmployees (@RequestParam ("firstName") String firstName, @RequestParam ("lastName") String lastName) {
